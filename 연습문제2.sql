...
SELECT EMPLOYEE_ID, COMMISSION_PCT * SALARY AS 실제커미션
  FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, TO_CHAR(SALARY, '9,999,999'), COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
 FROM (SELECT *
          FROM EMPLOYEES
...
SELECT  CEIL(TO_CHAR(HIRE_DATE, 'MM.DD'))
  FROM EMPLOYEES;
