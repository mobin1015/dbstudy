...
SELECT D.DEPARTMENT_NAME, COUNT(E.EMPLOYEE_ID) AS 사원수, AVG(SALARY) AS 평균연봉
  FROM DEPARTMENTS D INNER JOIN EMPLOYEES E
    ON D.DEPARTMENT_ID = E.DEPARTMENT_ID
 GROUP BY D.DEPARTMENT_NAME HAVING D.DEPARTMENT_NAME IS NOT NULL;
...
SELECT E.EMPLOYEE_ID AS 사원번호, E.JOB_ID AS 현재JOB_ID , JH.JOB_ID AS 예전JOB_ID 
